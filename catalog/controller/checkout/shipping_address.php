...
class ControllerCheckoutShippingAddress extends Controller {
	public function index() {
		...
		if (isset($this->session->data['shipping_address']['country_id'])) {
			...
			$this->session->data['shipping_address']['country_id'] = '206';
		}
		...
		if (isset($this->session->data['shipping_address']['zone_id'])) {
			...
			$data['zone_id'] = '3149';
			$this->session->data['shipping_address']['zone_id'] = '3149';
		}
	...
	public function save() {
		...
		if (!$json) {
			if (isset($this->request->post['shipping_address']) && $this->request->post['shipping_address'] == 'existing') {
				...
				$this->request->post['city']='3149';
				$this->request->post['company']='';
				$this->request->post['address_2']='';
				$this->request->post['country_id']='206';
