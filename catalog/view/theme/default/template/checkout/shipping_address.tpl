<form class="form-horizontal">
  ...
  <div id="shipping-existing">
    <select name="address_id" class="form-control">
      ...
      <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['firstname']; ?>, <?php echo $address['zone']; ?> <?php echo $address['address_1']; ?></option>
      <?php } else { ?>
      <option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?>, <?php echo $address['zone']; ?> <?php echo $address['address_1']; ?></option>
      <?php } ?>
      <?php } ?>
    </select>
  </div>
