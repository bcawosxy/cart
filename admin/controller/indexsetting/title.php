<?php
class ControllerindexSettingtitle extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('indexsetting/title');

		$this->document->setTitle($this->language->get('heading_title'));

		$this->load->model('extension/module');

		$name = 'indexTitle';		//要取得首頁的標題必須使用這個name當作辨識
		$code = 'html';				//module 預設的code名稱
		...
		$data['action'] = $this->url->link('indexsetting/title', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('indexsetting/title', $data));
	}
