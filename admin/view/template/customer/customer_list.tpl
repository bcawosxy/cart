                  ...
                  <td class="text-right"><?php if ($customer['approve']) { ?>
                    ...
                    <div class="btn-group" data-toggle="tooltip" title="<?php echo $button_login; ?>">
                      ...
                      <ul class="dropdown-menu pull-right">
                        <li><a href="index.php?route=customer/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>&store_id=0" target="_blank"><?php echo $config_name; ?></a></li>
