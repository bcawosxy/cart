                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">                      
                      ...
                      <input id="tagText" type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>" placeholder="<?php echo $entry_tag; ?>" id="input-tag<?php echo $language['language_id']; ?>" class="form-control" />
                      
                      <select id="tagsSelect" data-placeholder="選擇常用標籤">
                        <option selected="selected" disabled="disabled">選擇常用標籤</option>
                        <?php
                          $n = 0;
                          foreach($hotTags as $k0 => $v0) {
                            ...
                            if($n > 30) {
                              ...
                              echo '<option data-tags="'.$k0.'" value="'.$k0.'">['.$k0.']</option>&nbsp;';
                            }
                          }
                        ?>
                      </select>
...
$('#tagsSelect').chosen({
  no_results_text: '找不到搜尋結果。',
  search_contains :true,
  width:'100%',
}).on('change', function(evt, params) {
  $('#tagText').val($('#tagText').val()+params.selected+',');
});
//--></script></div>
<?php echo $footer; ?>
